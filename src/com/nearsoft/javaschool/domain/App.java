...
public class App {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("Total of available spots: " + parkingLotServices.getFreeSpots(parkingLot));
        ...
        for (Vehicle car : cars) {
            ...
            System.out.println("Total of available spots: " + parkingLotServices.getFreeSpots(parkingLot));
            if (parkingLotServices.park(car, parkingLot)) {
        ...
        for (Vehicle car : cars) {
            ...
            System.out.println("Total of available spots: " + parkingLotServices.getFreeSpots(parkingLot));
            double fare = parkingLotServices.clearSpot(car, parkingLot);
            if (fare > 0) {
